...
const reviews = [
  {
    ...
    role: "Paediatrician",
    content:
      "I use Jigson's medicines for many of my young patients. They work well, are safe, and parents find them easy to use. It's a brand I trust in daily practice.",
    rating: 5,
    image: "RS",
  },
  {
    ...
    content:
      "Working with Jigson has been smooth. Their products are consistent, paperwork is clear, and deliveries come on time. It makes our job easier.",
    rating: 5,
    image: "SP",
  },
  {
    ...
    content:
      "We've been ordering Jigson products for a long time. Quality is steady, no complaints from doctors, and all compliance documents are always in place.",
    rating: 5,
    image: "RS",
  },
  {
    ...
    role: "Parent",
    content:
      "My child's doctor suggested Jigson. The medicine suited my kid well and showed results quickly. I feel comfortable using their products now.",
    rating: 5,
    image: "PA",
  },
  {
    ...
    content:
      "In our clinic, we prefer brands that are dependable. Jigson's paediatric range has been reliable for years, and kids respond well to their formulations.",
    rating: 5,
    image: "HM",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-up">
              ...
              <p className="text-lg text-muted-foreground mb-4 max-w-lg leading-relaxed">
                High-quality paediatric formulations you can rely on for your
                kids.
              </p>
        ...
        <div className="container-wide">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Our most trusted paediatric formulations recommended by healthcare
              professionals.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/5 to-accent/5 p-4 hover:shadow-lg transition-all duration-300">
                  <div className="aspect-square rounded-xl overflow-hidden mb-3">
                    <img
                      src={cetzixAm}
                      alt="Cetzix-AM Antibiotic"
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-accent/5 to-primary/5 p-4 hover:shadow-lg transition-all duration-300">
                  <div className="aspect-square rounded-xl overflow-hidden mb-3">
                    <img
                      src={spobioCl}
                      alt="Spobio-CL Probiotic"
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                    />
                  </div>
                  <div className="text-center">
              ...
              <div className="bg-card rounded-2xl p-6 border border-border">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="text-center p-3 rounded-lg bg-primary/5">
                    <div className="text-lg font-bold text-primary">FDA</div>
                    <div className="text-xs text-muted-foreground">
                      Approved
                    </div>
                  </div>
                  <div className="text-center p-3 rounded-lg bg-accent/5">
                    <div className="text-lg font-bold text-accent">WHO</div>
              ...
              <div className="bg-gradient-to-r from-primary to-accent rounded-2xl p-6 text-primary-foreground">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-3xl font-extrabold mb-1">2016</div>
            ...
            <div className="space-y-6">
              <span className="badge badge-primary">About Jigson Pharma</span>
              <h2 className="text-3xl md:text-4xl font-extrabold text-foreground leading-tight">
                Specialised Paediatric Formulations Built on Quality & Safety
              </h2>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Since 2016, Jigson Pharma has been delivering specialised
                paediatric formulations built on quality, safety, and scientific
                precision. We focus on high-quality, high-standard and
                high-stability products trusted by healthcare professionals
                worldwide.
              </p>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-card border border-border hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Specially formulated for children's unique needs
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 rounded-xl bg-card border border-border hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Trusted by healthcare professionals globally
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <img
            ...
            alt="Medical certificates and approvals"
      ...
      <section className="section-padding bg-gradient-to-r from-primary via-blue-medium to-primary">
        <div className="container-wide text-center text-primary-foreground">
          ...
          <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Join our network of healthcare partners and experience the Jigson
            difference in quality, reliability, and paediatric expertise.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
